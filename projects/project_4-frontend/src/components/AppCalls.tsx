...
// Note: Contract client will be generated after running: npm run generate:app-clients
...
const AppCalls = ({ openModal, setModalState }: AppCallsInterface) => {
  ...
  const sendAppCall = async () => {
    ...
    // TODO: Contract client needs to be generated first
    // Run: npm run generate:app-clients
    // Then uncomment HelloWorldFactory import above
    
    enqueueSnackbar('Contract client not yet generated. Run: npm run generate:app-clients', { variant: 'warning' })
    setLoading(false)

    // Original code (uncomment after generating contract client):
